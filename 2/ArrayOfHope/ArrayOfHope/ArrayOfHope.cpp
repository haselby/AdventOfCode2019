// ArrayOfHope.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main(){
	...
	int puzzle[n_input];
	setup_trial(puzzle, input, n_input, 3, 4);
	printf("Value at location 2: %d\n", puzzle[2]);
}
