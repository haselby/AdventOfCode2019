...
/* Boost Logging Framework Integration
 * 
 * C/C++ - Additional Include Directories:
 *     C:\devtools\boost_1_75_0
 * Linker - Additional Library Directories:
 *   C:\devtools\boost_1_75_0
 *   C:\devtools\boost_1_75_0\stage\lib folder to:
 *
...
public:
	InstructionDecoder(int instruction) : instruction{ instruction } {
		set_opcode();
		set_num_parameters();
		set_parameter_mode();
	};
...
int main()
{
	...
	// My Puzzle Input from AdventOfCode
	...
	std::vector<int> orderedPhases; // Initally empty, built up from puzzlePhases
	std::set<int> puzzlePhases = { 5,6,7,8,9 };
	int maxThrust{ 0 };


	// Start: Test a single run
	...
	// End: Test a single run 


	// Run Every Permutation of puzzle phases, looking for the one that creates maxThrust.
